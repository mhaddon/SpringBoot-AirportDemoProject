...
docker run -v ~/git/SpringBoot-AirportDemoProject/:/var/www/site -p 8080:8082 -p 5005:5005 openjdk /usr/bin/java -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=5005 -jar /var/www/site/target/airportdemo-1.0.war